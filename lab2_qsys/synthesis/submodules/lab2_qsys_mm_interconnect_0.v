...
module lab2_qsys_mm_interconnect_0 (
		...
		output wire [1:0]  digit1_s1_address,                              //                                digit1_s1.address
		...
		output wire [1:0]  digit2_s1_address,                              //                                digit2_s1.address
	...
	wire  [94:0] digit1_s1_agent_rf_source_data;                                                     // digit1_s1_agent:rf_source_data -> digit1_s1_agent_rsp_fifo:in_data
	...
	wire  [94:0] digit1_s1_agent_rsp_fifo_out_data;                                                  // digit1_s1_agent_rsp_fifo:out_data -> digit1_s1_agent:rf_sink_data
	...
	wire         cmd_mux_004_src_valid;                                                              // cmd_mux_004:src_valid -> digit1_s1_agent:cp_valid
	wire  [93:0] cmd_mux_004_src_data;                                                               // cmd_mux_004:src_data -> digit1_s1_agent:cp_data
	wire         cmd_mux_004_src_ready;                                                              // digit1_s1_agent:cp_ready -> cmd_mux_004:src_ready
	wire   [6:0] cmd_mux_004_src_channel;                                                            // cmd_mux_004:src_channel -> digit1_s1_agent:cp_channel
	wire         cmd_mux_004_src_startofpacket;                                                      // cmd_mux_004:src_startofpacket -> digit1_s1_agent:cp_startofpacket
	wire         cmd_mux_004_src_endofpacket;                                                        // cmd_mux_004:src_endofpacket -> digit1_s1_agent:cp_endofpacket
	...
	wire  [94:0] digit0_s1_agent_rf_source_data;                                                     // digit0_s1_agent:rf_source_data -> digit0_s1_agent_rsp_fifo:in_data
	...
	wire  [94:0] digit0_s1_agent_rsp_fifo_out_data;                                                  // digit0_s1_agent_rsp_fifo:out_data -> digit0_s1_agent:rf_sink_data
	...
	wire         cmd_mux_005_src_valid;                                                              // cmd_mux_005:src_valid -> digit0_s1_agent:cp_valid
	wire  [93:0] cmd_mux_005_src_data;                                                               // cmd_mux_005:src_data -> digit0_s1_agent:cp_data
	wire         cmd_mux_005_src_ready;                                                              // digit0_s1_agent:cp_ready -> cmd_mux_005:src_ready
	wire   [6:0] cmd_mux_005_src_channel;                                                            // cmd_mux_005:src_channel -> digit0_s1_agent:cp_channel
	wire         cmd_mux_005_src_startofpacket;                                                      // cmd_mux_005:src_startofpacket -> digit0_s1_agent:cp_startofpacket
	wire         cmd_mux_005_src_endofpacket;                                                        // cmd_mux_005:src_endofpacket -> digit0_s1_agent:cp_endofpacket
	...
	wire  [94:0] digit2_s1_agent_rf_source_data;                                                     // digit2_s1_agent:rf_source_data -> digit2_s1_agent_rsp_fifo:in_data
	...
	wire  [94:0] digit2_s1_agent_rsp_fifo_out_data;                                                  // digit2_s1_agent_rsp_fifo:out_data -> digit2_s1_agent:rf_sink_data
	...
	wire         cmd_mux_006_src_valid;                                                              // cmd_mux_006:src_valid -> digit2_s1_agent:cp_valid
	wire  [93:0] cmd_mux_006_src_data;                                                               // cmd_mux_006:src_data -> digit2_s1_agent:cp_data
	wire         cmd_mux_006_src_ready;                                                              // digit2_s1_agent:cp_ready -> cmd_mux_006:src_ready
	wire   [6:0] cmd_mux_006_src_channel;                                                            // cmd_mux_006:src_channel -> digit2_s1_agent:cp_channel
	wire         cmd_mux_006_src_startofpacket;                                                      // cmd_mux_006:src_startofpacket -> digit2_s1_agent:cp_startofpacket
	wire         cmd_mux_006_src_endofpacket;                                                        // cmd_mux_006:src_endofpacket -> digit2_s1_agent:cp_endofpacket
	...
	wire         digit1_s1_agent_rp_valid;                                                           // digit1_s1_agent:rp_valid -> router_006:sink_valid
	wire  [93:0] digit1_s1_agent_rp_data;                                                            // digit1_s1_agent:rp_data -> router_006:sink_data
	wire         digit1_s1_agent_rp_ready;                                                           // router_006:sink_ready -> digit1_s1_agent:rp_ready
	wire         digit1_s1_agent_rp_startofpacket;                                                   // digit1_s1_agent:rp_startofpacket -> router_006:sink_startofpacket
	wire         digit1_s1_agent_rp_endofpacket;                                                     // digit1_s1_agent:rp_endofpacket -> router_006:sink_endofpacket
	...
	wire         digit0_s1_agent_rp_valid;                                                           // digit0_s1_agent:rp_valid -> router_007:sink_valid
	wire  [93:0] digit0_s1_agent_rp_data;                                                            // digit0_s1_agent:rp_data -> router_007:sink_data
	wire         digit0_s1_agent_rp_ready;                                                           // router_007:sink_ready -> digit0_s1_agent:rp_ready
	wire         digit0_s1_agent_rp_startofpacket;                                                   // digit0_s1_agent:rp_startofpacket -> router_007:sink_startofpacket
	wire         digit0_s1_agent_rp_endofpacket;                                                     // digit0_s1_agent:rp_endofpacket -> router_007:sink_endofpacket
	...
	wire         digit2_s1_agent_rp_valid;                                                           // digit2_s1_agent:rp_valid -> router_008:sink_valid
	wire  [93:0] digit2_s1_agent_rp_data;                                                            // digit2_s1_agent:rp_data -> router_008:sink_data
	wire         digit2_s1_agent_rp_ready;                                                           // router_008:sink_ready -> digit2_s1_agent:rp_ready
	wire         digit2_s1_agent_rp_startofpacket;                                                   // digit2_s1_agent:rp_startofpacket -> router_008:sink_startofpacket
	wire         digit2_s1_agent_rp_endofpacket;                                                     // digit2_s1_agent:rp_endofpacket -> router_008:sink_endofpacket
	...
	wire         digit1_s1_agent_rdata_fifo_src_valid;                                               // digit1_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_004:in_0_valid
	wire  [33:0] digit1_s1_agent_rdata_fifo_src_data;                                                // digit1_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_004:in_0_data
	wire         digit1_s1_agent_rdata_fifo_src_ready;                                               // avalon_st_adapter_004:in_0_ready -> digit1_s1_agent:rdata_fifo_src_ready
	wire         avalon_st_adapter_004_out_0_valid;                                                  // avalon_st_adapter_004:out_0_valid -> digit1_s1_agent:rdata_fifo_sink_valid
	wire  [33:0] avalon_st_adapter_004_out_0_data;                                                   // avalon_st_adapter_004:out_0_data -> digit1_s1_agent:rdata_fifo_sink_data
	wire         avalon_st_adapter_004_out_0_ready;                                                  // digit1_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_004:out_0_ready
	wire   [0:0] avalon_st_adapter_004_out_0_error;                                                  // avalon_st_adapter_004:out_0_error -> digit1_s1_agent:rdata_fifo_sink_error
	wire         digit0_s1_agent_rdata_fifo_src_valid;                                               // digit0_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_005:in_0_valid
	wire  [33:0] digit0_s1_agent_rdata_fifo_src_data;                                                // digit0_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_005:in_0_data
	wire         digit0_s1_agent_rdata_fifo_src_ready;                                               // avalon_st_adapter_005:in_0_ready -> digit0_s1_agent:rdata_fifo_src_ready
	wire         avalon_st_adapter_005_out_0_valid;                                                  // avalon_st_adapter_005:out_0_valid -> digit0_s1_agent:rdata_fifo_sink_valid
	wire  [33:0] avalon_st_adapter_005_out_0_data;                                                   // avalon_st_adapter_005:out_0_data -> digit0_s1_agent:rdata_fifo_sink_data
	wire         avalon_st_adapter_005_out_0_ready;                                                  // digit0_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_005:out_0_ready
	wire   [0:0] avalon_st_adapter_005_out_0_error;                                                  // avalon_st_adapter_005:out_0_error -> digit0_s1_agent:rdata_fifo_sink_error
	wire         digit2_s1_agent_rdata_fifo_src_valid;                                               // digit2_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_006:in_0_valid
	wire  [33:0] digit2_s1_agent_rdata_fifo_src_data;                                                // digit2_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_006:in_0_data
	wire         digit2_s1_agent_rdata_fifo_src_ready;                                               // avalon_st_adapter_006:in_0_ready -> digit2_s1_agent:rdata_fifo_src_ready
	wire         avalon_st_adapter_006_out_0_valid;                                                  // avalon_st_adapter_006:out_0_valid -> digit2_s1_agent:rdata_fifo_sink_valid
	wire  [33:0] avalon_st_adapter_006_out_0_data;                                                   // avalon_st_adapter_006:out_0_data -> digit2_s1_agent:rdata_fifo_sink_data
	wire         avalon_st_adapter_006_out_0_ready;                                                  // digit2_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_006:out_0_ready
	wire   [0:0] avalon_st_adapter_006_out_0_error;                                                  // avalon_st_adapter_006:out_0_error -> digit2_s1_agent:rdata_fifo_sink_error
	...
	lab2_qsys_mm_interconnect_0_cmd_demux_001 rsp_demux_002 (
		.clk                (clk_0_clk_clk),                                  //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
